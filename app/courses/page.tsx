...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Industry-focused training with real internships and placement support across specialized programs.',
    url: 'https://www.theplacemate.in/courses/',
    siteName: 'PlaceMate',
    images: [{ url: '/og-courses.png', width: 1200, height: 630 }],
  },
  twitter: { card: 'summary_large_image', title: 'PlaceMate Courses', description: 'Explore industry-focused training programs with placement support.' },
      ...
      <section className="relative pt-28 pb-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center mb-16">
            <span className="tag mb-4 inline-flex">Industry Training Programs</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {COURSES.map((course) => (
              <Link
                ...
                className="group relative glass rounded-2xl p-6 border border-white/[0.06] hover:border-white/[0.15] transition-all duration-500 cursor-pointer overflow-hidden card-hover block flex flex-col justify-between"
              >
                <div
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-2 bg-white/[0.03] rounded-lg px-3 py-2 mb-4 border border-white/[0.04]">
                    ...
                    <span className="text-[10px] text-[#94a3b8] truncate">{course.internship}</span>
                  </div>

                  <div
                    className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-semibold border border-white/[0.08] group-hover:border-opacity-60 transition-all"

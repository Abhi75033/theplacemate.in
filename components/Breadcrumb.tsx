    ...
    <>
      ...
      <div className="flex justify-start mb-6 md:mb-8 mt-2">
        <nav 
          ...
          className="dark-theme inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-slate-950/80 backdrop-blur-md border border-white/[0.08] shadow-[0_4px_12px_rgba(0,0,0,0.15)] text-[11px] text-slate-400 flex-nowrap overflow-x-auto scrollbar-hide max-w-full transition-all duration-300 hover:border-white/15 hover:shadow-[0_6px_20px_rgba(0,0,0,0.25)]"
        >
          {allItems.map((item, i) => (

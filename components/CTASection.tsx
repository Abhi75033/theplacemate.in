    ...
    <section id="apply" className="section-padding relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }}
          ...
          <a href="#" data-action="apply" className="btn-primary flex items-center justify-center gap-2 text-base sm:text-lg px-8 py-4 relative z-10 glow-purple">
            <span className="relative z-10">Apply Now — It&apos;s Free</span>
            <ArrowRight className="w-5 h-5 relative z-10" />
          </a>
          <a href="#" data-action="counseling" className="btn-secondary flex items-center justify-center gap-2 text-base sm:text-lg px-8 py-4">

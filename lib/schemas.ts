...
export function articleSchema(post: { title: string; description: string; slug: string; date: string; modified: string }) {
  return {
    ...
    author: { '@type': 'Organization', name: 'PlaceMate', url: 'https://www.theplacemate.in/', logo: 'https://www.theplacemate.in/logo.png' },
    ...
    mainEntityOfPage: `https://www.theplacemate.in/blog/${post.slug}/`,
    image: 'https://www.theplacemate.in/logo.png',
  }
}
